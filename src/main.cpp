...
bool travel(int ans, string people[], string items[], Party p, Person * all, Person John, Person Sally, Person Tim) {
    if (ans == 0) {
        ...
        string actions[16][2] = {
            ...
            {
                to_string(2),
                "Your party has been robbed while you were sleeping."
            },
            {
                to_string(3),
                "Your party is attacked by a pack of wolves."
            },
            {
                to_string(4),
                "You found a broken down wagon with extra supplies."
            },
            {
                to_string(5),
                "You find an oxen that seems to have run away from its party."
            },
            {
                to_string(6),
